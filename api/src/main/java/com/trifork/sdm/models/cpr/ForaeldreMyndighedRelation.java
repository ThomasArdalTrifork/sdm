...
public class ForaeldreMyndighedRelation extends CPREntity {
	...
	public void setForaeldreMyndighedMarkering(
			String foraeldreMyndighedMarkering) {
	...
	public Calendar getValidFrom() {
		return (foraeldreMyndighedStartDato == null) ? super.getValidFrom()
				: DateUtils.toCalendar(foraeldreMyndighedStartDato);
	}

	@Override
	public Calendar getValidTo() {
		return (foraeldreMyndighedSlettedato == null) ? super.getValidTo()
				: DateUtils.toCalendar(foraeldreMyndighedSlettedato);
	}
