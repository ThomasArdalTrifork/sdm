...
public class TakstRelease extends AbstractRecord {
	...
	public Map<Object, Administrationsvej> administrationsveje;
	...
	public TakstRelease(Date validFrom, Date validTo, int releaseYear, int releaseWeek) {

		setValidFrom(validFrom);
		setValidTo(validTo);
		setValidityYear(releaseYear);
		setValidityWeekNumber(releaseWeek);
	}
