...
public class UmyndiggoerelseVaergeRelation extends CPREntity {
	...
	public Calendar getValidFrom() {
		...
		// produktionsdatoen
		return (umyndigStartDato == null) ? super.getValidFrom()
				: (umyndigStartDato.after(super.getValidFrom().getTime())) ? DateUtils
						.toCalendar(umyndigStartDato) : super.getValidFrom();
	}
