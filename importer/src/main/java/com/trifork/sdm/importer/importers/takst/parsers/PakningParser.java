...
public class PakningParser extends AbstractParser<Pakning> {

	private final Map<Object, Laegemiddel> drugs;


	public PakningParser(Map<Object, Laegemiddel> drugs) {
	...
	public Set<Pakning> read(File f) throws IOException {
