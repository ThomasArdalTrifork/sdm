...
public class BeregningsreglerParser extends AbstractParser<Beregningsregler> {
	...
	public Set<Beregningsregler> read(String rootFolder) throws IOException {

		File f = new File(rootFolder + getLmsName().toLowerCase() + ".txt");

		Set<Beregningsregler> list = new HashSet<Beregningsregler>();
