...
public class DoseringskodeFactory extends AbstractFactory<Doseringskode> {
	...
	public Set<Doseringskode> read(String rootFolder) throws IOException {

		File f = new File(rootFolder + getLmsName().toLowerCase() + ".txt");

		Set<Doseringskode> list = new HashSet<Doseringskode>();
