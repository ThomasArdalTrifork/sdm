...
public class PakningskombinationerFactory extends AbstractFactory<Pakningskombinationer> {
	...
	public Set<Pakningskombinationer> read(String rootFolder) throws IOException {

		File f = new File(rootFolder + getLmsName().toLowerCase() + ".txt");

		Set<Pakningskombinationer> list = new HashSet<Pakningskombinationer>();
