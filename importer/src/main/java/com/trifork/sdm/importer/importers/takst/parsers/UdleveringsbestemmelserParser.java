...
public class UdleveringsbestemmelserParser extends AbstractParser<Udleveringsbestemmelser> {
	...
	public Set<Udleveringsbestemmelser> read(String rootFolder) throws IOException {

		File f = new File(rootFolder + getLmsName().toLowerCase() + ".txt");

		Set<Udleveringsbestemmelser> list = new HashSet<Udleveringsbestemmelser>();
