...
public class KlausuleringFactory extends AbstractFactory<Klausulering> {
	...
	public Set<Klausulering> read(String rootFolder) throws IOException {

		File f = new File(rootFolder + getLmsName().toLowerCase() + ".txt");

		Set<Klausulering> list = new HashSet<Klausulering>();
