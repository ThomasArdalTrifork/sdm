...
public class AdministrationsvejParser extends AbstractFactory<Administrationsvej> {
	...
	public Set<Administrationsvej> read(String rootFolder) throws IOException {

		File f = new File(rootFolder + "lms11.txt");
		Set<Administrationsvej> list = new HashSet<Administrationsvej>();
