...
public class EmballagetypeKoderParser extends AbstractParser<EmballagetypeKoder> {
	...
	public Set<EmballagetypeKoder> read(String rootFolder) throws IOException {

		File f = new File(rootFolder + getLmsName().toLowerCase() + ".txt");

		Set<EmballagetypeKoder> list = new HashSet<EmballagetypeKoder>();
