...
public class LaegemiddelParser extends AbstractParser<Laegemiddel> {

	private final Map<Object, LaegemiddelformBetegnelser> betegnelser;
	private final Map<Object, ATCKoderOgTekst> atcTexts;


	public LaegemiddelParser(Map<Object, LaegemiddelformBetegnelser> betegnelser, Map<Object, ATCKoderOgTekst> atcTexts) {
	...
	private void setFieldValue(Laegemiddel obj, int fieldNo, String value) {
		...
		case 15:
			...
			for (int offset = 0; offset < value.length(); offset += CODE_LENGTH) {

				String code = value.substring(offset, offset + CODE_LENGTH);
				obj.addAdministrationCode(code);
			}
	...
	public Map<Object, Laegemiddel> read(File f) throws IOException {
