...
public class MySQLConnectionManager
{
	...
	private static final String HOUSEKEEPING_DATABASE_KEY = "db.housekeepingdatabase"; // TODO: Consolidate the schemas.
	...
	public static Connection getConnection()
	{
		...
		catch (Exception e)
		{
			...
			// COMMENT (thb): Should we not fail completely here and exit the application?
		}
	...
	{
		String confName = Configuration.getString(HOUSEKEEPING_DATABASE_KEY); // TODO: Should not be needed anymore.
