package com.trifork.sdm.importer.integration.cpr;
...
import com.trifork.sdm.importer.importers.cpr.CPRImporter;
import com.trifork.sdm.importer.importers.cpr.CPRParser;
...
public class CPRIntegrationTest {
	...
	private static final String TESTDATA_DIR = "/src/test/resources/testdata/cpr/";
	...
	public void ImportPersonNavnebeskyttelsesTest() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "testCPR1/D100314.L431101");
	...
	public void ImportForaeldreMyndighedBarnTest() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "testForaeldremyndighed/D100314.L431101");
	...
	public void ImportUmyndighedVaergeTest() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "testUmyndigVaerge/D100314.L431101");
	...
	public void ImportU12160Test() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "D100312.L431101");
	...
	public void ImportU12170Test() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "D100313.L431101");
	...
	public void SequenceTest() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "testSequence1/D100314.L431101");
        ...
        fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "testSequence2/D100314.L431101");
        new CPRImporter().importFiles(Arrays.asList(fInitial));
        
        latestIkraft = CPRImporter.getLatestIkraft(con);
        assertEquals(CPRParser.yyyy_MM_dd.parse("2001-11-19"), latestIkraft.getTime());
        
        fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "testOutOfSequence/D100314.L431101");
        new CPRImporter().importFiles(Arrays.asList(fInitial));
        con.close();
	}
	...
	public void EtableringTest() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "testEtablering/D100313.L431102");
        ...
        // When running a full load (file doesn't ends on 01) of CPR no LatestIkraft should be written to the db
        Calendar latestIkraft = CPRImporter.getLatestIkraft(con);
	...
	public void UpdateTest() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "D100315.L431101");
        ...
        fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "D100317.L431101");
		new CPRImporter().importFiles(Arrays.asList(fInitial));
