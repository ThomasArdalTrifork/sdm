...
public class CPRNameAndAddressProtectionTest {
	...
	private static final String TESTDATA_DIR = "/src/test/resources/testdata/cpr/NameAndAddressProtection";
	...
	public void ImportPersonNavnebeskyttelsesUpdateWhenDayIsHereTest() throws Exception {
		// Arrange
		File fInitial = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "/D100312.L431101");
		File fEmpty = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "/D100313.L431101");
		File fNewNameAdress = new File(PROJECT_BASE_DIR + TESTDATA_DIR + "/D100314.L431101");
		...
		// Set 'NavneBeskyttelseStartDato' and make sure its moved when 'NavneBeskyttelseStartDato' is reached 
		...
		// Check protection of name and address but not the other informations (Stilling=Bensionist)
